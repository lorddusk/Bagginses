 ...
 */
public class ContainerTier2 extends ContainerMain {
    private IInventory bag;


    public ContainerTier2(InventoryPlayer playerInventory, ItemStack itemStack) {
        bag = new InventoryItemMain(itemStack, 27, 64);
        ContainerUtil.addSlots(this, bag, 0, 3, 9, 8, 19);
